        ...
        <div class="w-3/4 my-mt-3 mb-8 flex">
            <div>
                <div class="flex items-center my-5 card">
                    ...
                    <div class="w-2/3 ml-3 transition-all">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dicta, in at? Ullam, architecto. Perferendis, officiis aliquam. Amet maiores aspernatur ab consequuntur error quaerat obcaecati eum facilis, iste vitae? Quo, dolores.</div>
                </div>
                <div class="flex items-center my-5 card">
                    <div class="w-40 h-56 bg-gray-300 shadow-lg rounded-lg"></div>
                    <div class="w-2/3 ml-3 transition-all">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dicta, in at? Ullam, architecto. Perferendis, officiis aliquam. Amet maiores aspernatur ab consequuntur error quaerat obcaecati eum facilis, iste vitae? Quo, dolores.</div>
