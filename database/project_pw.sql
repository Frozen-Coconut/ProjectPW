...
('Casio CT-X5000 61-Key Portable Keyboard', 5, 6, 6067000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FC32-CT-X5000_2FC32-CT-X5000_1622175245030.jpg?v=1631182662', 'Seri CT-X dilengkapi dengan Sumber Suara AiX, yang dapat menghasilkan berbagai kualitas suara dari nada bass yang kuat hingga nada tinggi yang jernih. Kekuatan komputasi yang luar biasa dari LSI performa tinggi mereproduksi pesona alami suara instrumen akustik, seperti perubahan nada yang menyenangkan saat tuts piano dipukul, sensasi performa drum, atau senar yang melonjak. Prosesor sinyal digital berkecepatan tinggi juga diterapkan untuk setiap jenis suara, seperti melodi, backing drum dan bass, atau organ. Bahkan ansambel standar untuk keyboard memberikan suara yang berbeda untuk setiap instrumen untuk kinerja yang ekspresif.\n		Specifications:\n\nKeyboard: 61 standard size keys\nTouch Response: Sensitivity 3 types, Off\nMaximum Polyphony: 64 notes (32 for certain tones)\nTonesPreset Tones: 800, User Tones: 100, Other: Layer, split (configurable split point, lower point, chord point settings)\nSystem Effects: Reverb: 32 types, Off, Chorus: 16 types, Tones, Delay: 20 types, Tones, DSP: 100 types (Can be applied to user tones using DSP editing.), DSP tones\nMaster Effects: Equalizer (10 presets), 4-band User Equalizer\nExternal Input Effects: Center cancel (vocal cut) for input from the Audio In jack\nMetronome Beat: 0 (accented tone off), 1 to 16, Tempo: Tempo value: 20 to 255\nDemo Songs: 3\nSong Bank: 30 Built-in Song, User-recorded Songs: 10, USB Memory Songs: Playback of standard MIDI files (SMF format 0/1), CASIO MIDI files (CMF format) on a USB flash drive is supported \nUSB Audio Playback: Playback of audio files on a USB flash drive is supported, Supported File Formats: WAV format, 44.1 kHz 16 bit, Other Functions: Center Cancel (Vocal Cut)\nAuto AccompanimentBuilt-in Rhythms: 235, User Rhythms: 100. One Touch Presets 235\nMusic Presets: 310 (With chord progressions) \nPhrase Pads: Number of Pads: 4, User Phrases: 100 (4 phrases x 25 pads), Editing Mode: Copy, delete, phrase editing\nMixer function: Affected Parts: Sound source parts, microphone input part, Parameters: Part on/off, volume, pan, reverb send, chorus send, delay send\nRegistration: Maximum 128 setups (8 setups x 16 banks), registration sequence\nTone Editing: Preset tone editing, DSP editing, Memory for storage of edited tones (up to 100)\nRhythm Editing: New rhythm creation, rhythm editing, Memory for storage of created/edited rhythms (up to 100)\nMIDI Recorder: Real-time recording, playback, Keyboard Performance Recording: 10 songs, 17 tracks (1 system track, 16 solo tracks), Memory Capacity: Approximately 40,000 notes (per song), Editing Mode: Song editing, track editing, event editing, step input, Other Functions: Overdubbing, punch-in recording\nPedals: Sustain, sostenuto, soft, rhythm/song, expression\nControllers: Pitch bend wheel, SUSTAIN button, PORTAMENTO button, MODULATION/ ASSIGNABLE button\nMIDI: 16ch multi-timbre received, GM Level 1 standard\nInputs/Outputs: USB Flash Drive Port: Type A, USB Port: Type B, Pedal 1 Jack: Standard jack, Pedal 2, Expression Jack: Standard jack, Headphones Jack: Stereo standard jack, Audio Input Jack: Stereo mini jack/Input impedance 9 kΩ, Input sensitivity 200 mV, Line Out Jack: Standard jacks x 2/Output impedance 2.3 kΩ, Output voltage 1.9 V (RMS) MAX, Microphone Input Jack: Standard jack (Connect a dynamic microphone.)/ Input impedance 3 kΩ, Input sensitivity 10 mV\nPower Jack: DC 24V\nPower Suppl: yAC adaptor only\nAC Adaptor: AD-E24250LW\nAuto Power Off: Approximately 30 minutes after last operation; Can be disabled.\nSpeakers: 10cm x 2 (Output: 15W + 15W)\nPower Consumption: 15 W\nDimensions: W 94.8 x D 38.4 x H 11.6 cm\nWeight: Approximately 7.0 kg\nIncluded Accessories: Music stand, AC adaptor', 0, NULL),
('Casio CT-X800 61-Key Portable Keyboard', 5, 6, 3224800, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FC32-CT-X800_2FC32-CT-X800_1622174202860.jpg?v=1623321949', 'Seri CT-X dilengkapi dengan Sumber Suara AiX, yang dapat menghasilkan berbagai kualitas suara dari nada bass yang kuat hingga nada tinggi yang jernih. Kekuatan komputasi yang luar biasa dari LSI performa tinggi mereproduksi pesona alami suara instrumen akustik, seperti perubahan nada yang menyenangkan saat tuts piano dipukul, sensasi performa drum, atau senar yang melonjak. Prosesor sinyal digital berkecepatan tinggi juga diterapkan untuk setiap jenis suara, seperti melodi, backing drum dan bass, atau organ. Bahkan ansambel standar untuk keyboard memberikan suara yang berbeda untuk setiap instrumen untuk kinerja yang ekspresif.\n		\n		Specifications:\n\nKeyboard: 61 standard size keys\nTouch Response: Sensitivity 3 types, Off\nMaximum Polyphony: 48 notes (24 for certain tones)\nBuilt-in Tones: 600\nFunctions: Layer, Split, Piano/Organ button\nDigital Effect: 1 to 20 Reverb and 1 to 10 Chorus\nMetronome: 0 to 9 Beats per Measure, 20 to 255 Tempo Range\nSong Bank: Demo Song: 1, Built-in Songs: 160, User Songs: 10, User-recorded songs: 6\nStep Up Lesson: Lessons: 3 (Listen, Watch, Remember), Easy Mode, Lesson Part: L, R, LR, Repeat, Voice Fingering Guide, Note Guide, Performance Evaluation\nChord Book Function: Chord guide\nRecorder: Real-time recording, playback, Keyboard Play: 5 songs, 6 tracks, Playing Along with a Built-in Songs: 1 song (L, R, LR), Memory Capacity: Approximately 40,000 notes (1 song)\nPreset Scales: 17\nMusic Preset: 310\nOne Touch Preset: 195\nAuto Harmonize: 12 types\nArpeggiator: 100 types\nMIDI: 16 multi-timbre received, GM Level 1 standard\nPitch Bend Wheel: Pitch Bend Range 0 to 24 semitones\nUSB Flash Drive: SMF direct playback, data storage, data loading, data deleting, USB flash drive format\nInputs/OutputsUSB flash drive port: TYPE A, USB port: TYPE B, PEDAL jack: Standard jack (sustain, sostenuto, soft, rhythm), Phones/Output jack: Stereo standard jack/Output Impedance 167Ω, Output Voltage 4.5V (RMS) MAX, Audio In jack: Stereo mini jack/Input Impedance 10kΩ, Input Sensitivity 200mV\nPower Jack: DC 9.5V\nPower Supply: 2-way Batteries: 6 AA-size alkaline batteries, Battery Life: Approximately 3 hours continuous operation on alkaline batteries\nAC Adaptor: AD-E95100L\nAuto Power Off: Approximately 30 minutes after last operation; Can be disabled.\nSpeakers: 12cm x 2 (Output: 2.5W + 2.5W)\nPower Consumption: 7.5 W\nDimensions: W 94.8 x D 35.0 x H 10.9 cm\nWeight Approximately: 4.4 kg (without batteries)\nIncluded Accessories: Music stand', 0, NULL),
