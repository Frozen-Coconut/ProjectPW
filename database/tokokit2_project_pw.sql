...
--
-- Database: `tokokit2_project_pw`
--
CREATE DATABASE IF NOT EXISTS `tokokit2_project_pw` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `tokokit2_project_pw`;
...
('Amahi UK990C Classic Series Ebony Concert Ukulele', 1, 12, 2268135, 'https://cdn.shopify.com/s/files/1/1369/1865/products/UK990-2015-2_360x.png?v=1569147754', 'Sempurna untuk pemain pemula dan berpengalaman, ukulele UK990C ukuran konser Amahi menawarkan kualitas dan penampilan nada premium. Bagian atas, belakang, dan samping kayu eboni yang dilaminasi memberi UK990C perpaduan kayu yang indah secara estetis, dan bangunan yang terjamin dan kokoh yang akan bertahan bahkan di tangan strummer paling \"bersemangat\". Ini, ditambah dengan nada penuh yang dapat dibedakan dan rentang dinamis yang lebar, menjadikan ukulele kayu ebony ini pilihan yang fantastis untuk semua pemain yang benar-benar ingin menonjol.', 1, NULL),
('AVANTONE PRO MixCubes Active Black Mono Monitor Speaker', 2, 10, 6187500, 'https://hariharimusik.id/wp-content/uploads/2021/01/pro-mixcubes-active-mono.jpg', 'Meskipun awalnya terinspirasi oleh kubus suara 5C dari beberapa dekade yang lalu, Avantone MixCubes telah menjadi standar industri di studio di seluruh dunia dan telah menjadi pembicara terlaris # 1 dari jenisnya dalam sejarah. Avantone Active Mixcubes dirancang untuk menjadi monitor referensi mini bertenaga resolusi tinggi dan jangkauan penuh untuk lokasi tetap atau jauh.\r\nAspek teknik sekunder adalah menciptakan desain abadi yang melengkapi transduser full-range tunggal.', 0, NULL),
('BEHRINGER MS40 Digital 40-Watt Stereo Near Field Monitor speaker', 3, 8, 3400000, 'https://hariharimusik.id/wp-content/uploads/2021/08/24502027_e3893f9b-a6e6-4939-814c-0711b34de5ba_1000_1000-600x600.jpg', 'Monitor studio aktif 2 arah cocok untuk studio komputer, stasiun kerja audio dan multimedia, serta pemantauan keyboard\r\nBuilt-in 2 x 20-Watt amplifier kuat dengan ruang kepala besar\r\nWoofer yang kuat dan tweeter resolusi tinggi memberikan respons frekuensi ultra-linear\r\nKonverter D/A 24-bit/192 kHz resolusi ultra-tinggi untuk rentang dinamis yang luar biasa\r\nInput optik dan koaksial untuk langsung menghubungkan sumber audio digital dengan antarmuka S/PDIF\r\nDua input analog stereo yang menampilkan 1/8″ TRS dan konektor RCA stereo dapat digunakan secara bersamaan atau dicampur dengan sumber stereo digital\r\nKontrol volume individual untuk input Line ditambah kontrol Bass dan Treble EQ\r\n1/4″ Konektor headphone TRS dengan fungsi pengeras suara bisu otomatis yang mudah diakses di panel depan\r\nTerlindung secara magnetis untuk ditempatkan di dekat monitor komputer\r\nKomponen berkualitas tinggi dan konstruksi yang sangat kokoh memastikan masa pakai yang lama\r\nDiciptakan dan dirancang oleh BEHRINGER Jerman\r\nAmbil langkah selanjutnya dari MS20 dan dapatkan daya output yang lebih merata dan respons bass yang lebih lama! Monitor jarak dekat 2 x 20-Watt yang sangat ringkas ini menampilkan konverter D/A 24-bit/192 kHz resolusi ultra-tinggi. Dengan MS40, Anda dapat terhubung langsung ke sumber sinyal digital Anda dan menghilangkan kehilangan saluran analog yang mengganggu dan dengung selamanya. Baik Anda terhubung ke kartu suara komputer, keyboard, atau pemutar MP3, Anda akan menikmati kualitas suara yang luar biasa dengan dinamika yang luar biasa. Amplifier internal menyediakan banyak ruang kepala, sedangkan woofer dan tweeter yang kuat memberikan respons frekuensi ultra-linear.', 0, NULL),
('BEHRINGER PMP550M 500-Watt 5-Channel Powered Mixer', 3, 8, 4550000, 'https://hariharimusik.id/wp-content/uploads/2021/08/e8c2fe67-7b09-4e52-8c6f-fbd6af60d1ca-600x600.jpg', 'PMP550M Powered Mixer yang luar biasa mengemas daya yang luar biasa (2 x 250 Watt dual mono), sambil mempertahankan rasio power-to-weight yang luar biasa. Mixer ini menggunakan teknologi Kelas-D berefisiensi tinggi dan catu daya mode sakelar canggih, yang secara signifikan mengurangi berat dan panas. PMP550M 5-saluran memiliki 5 preamp mikrofon berkualitas tinggi (2 di antaranya juga menerima Mikrofon Nirkabel Digital ULM kami, tersedia secara terpisah) dan 1⁄8″; Input Aux untuk memutar musik dari perangkat pintar Anda. Untuk sentuhan ekstra profesional, kami menambahkan prosesor KLARK TEKNIK 24-bit Multi-FX dengan 25 preset termasuk reverb kelas studio, delay, pitch shifter dan berbagai multi-efek, ditambah EQ grafis stereo 7-band dengan Umpan Balik FBQ milik kami Sistem Deteksi – untuk performa bebas umpan balik terbaik.', 0, NULL),
('BEHRINGER QX2442USB 24-INPUT 4/2-BUS MIXER WITH XENYX MIC PREAMPS', 3, 8, 8420000, 'https://hariharimusik.id/wp-content/uploads/2021/09/QX2442USB_P0AL3_Top_B.png', 'Kebisingan ultra-rendah premium, mixer ruang kepala tinggi\r\n10 Preamp Mic XENYX bertenaga phantom canggih yang sebanding dengan preamp butik yang berdiri sendiri\r\n8 kompresor kelas studio dengan fungsi \"satu tombol\" super mudah dan LED kontrol untuk suara vokal dan instrumental profesional\r\nProsesor Klark Teknik FX berkualitas sangat tinggi dengan layar LCD, parameter ganda, fungsi Ketuk, dan pengaturan parameter pengguna yang dapat disimpan\r\n\"Siap nirkabel\" untuk sistem nirkabel digital Behringer berkualitas tinggi (tidak termasuk)\r\nAntarmuka USB/Audio stereo bawaan untuk terhubung langsung ke komputer Anda. Perangkat lunak perekaman, pengeditan, dan podcasting audio gratis plus 150 plug-in instrumen/efek yang dapat diunduh di behringer.com\r\nEQ 3-band \"Inggris\" neo-klasik dengan mid band semi-parametrik untuk suara hangat dan musik\r\nSisipan saluran dan keluaran langsung pada setiap saluran mono ditambah sisipan campuran utama untuk koneksi fleksibel peralatan tempel\r\n4 pengiriman aux per saluran: 2 fader pra/pasca dapat dialihkan untuk aplikasi pemantauan/FX, 2 fader pos (untuk FX internal atau sebagai pengiriman eksternal)\r\nKlip LED, mute, mix utama dan sakelar perutean subgrup, fungsi solo dan PFL di semua saluran\r\n4 subkelompok dengan output terpisah untuk menambah fleksibilitas perutean; 4 pengembalian aux stereo multi-fungsi dengan perutean yang fleksibel\r\nRuang kontrol/output telepon dengan matriks sumber multi-input; input rec dapat dialihkan ke mix utama atau ruang kontrol/output telepon\r\nFader lancip logaritmik 60 mm yang tahan lama dan kontrol putar tertutup\r\nCatu daya switching “Planet Earth” untuk fleksibilitas maksimum (100 – 240 V~), audio bebas noise, respons transien superior plus konsumsi daya rendah untuk penghematan energi\r\nDirancang dan direkayasa di Jerman', 0, NULL),
...
('Cannon Percussion Jamm Jr.3 PC. Drum Set', 4, 4, 3415597, 'https://cdn.shopify.com/s/files/1/0494/8113/products/JAMMJr3pc_blue_01.jpg?v=1606597735', 'Drum set ukuran anak untuk memulai drummer muda Anda dengan semua yang mereka butuhkan:\r\n\r\nbas drum 16\"\r\n10\" tom\r\n10\" jerat\r\n1 pedal drum bass\r\n1 stand Hi-Hat\r\n1 lengan simbal\r\n1 dudukan snare drum\r\n1 10 \"set hi-hats\r\nsimbal crash 1 12\"\r\n1 pasang stik drum\r\n1 kunci drum\r\n1 tahta', 0, NULL),
('Cannon Percussion Jamm Jr.5 PC. Drum Set', 4, 4, 4255442, 'https://cdn.shopify.com/s/files/1/0494/8113/products/JAMM_JR_5_PC_WINE_RED.jpg?v=1606598682', 'Drum set ukuran anak untuk memulai drummer muda Anda dengan semua yang mereka butuhkan:\r\n\r\nDrum Bass 16\" x 11\"\r\n8\" x 6\" Tom\r\n10\" x 6\" Tom\r\n12\" x 10\" Lantai Tom\r\nDrum Snare 10\" x 5\"\r\n1- Pedal Drum Bass\r\n1- Hi-Hat Stand\r\n1- Pemegang Simbal\r\n1- Dudukan Drum Snare\r\n1-Tahta\r\n1-10\" Pasang Simbal Hi-Hat\r\n1-12\" Crash Cymbal\r\n1 pasang stik drum\r\nkunci 1-drum', 0, NULL),
...
('Dave Smith Evolver Keys', 7, 11, 25348400, 'https://www.melodiamusik.com/wp-content/uploads/2016/08/evolver.jpg', 'Osilator – 2 osilator analog yang dikontrol secara digital (DCO) dengan gigi gergaji, segitiga, campuran gergaji/segitiga yang dapat dipilih, dan gelombang pulsa (dengan modulasi lebar pulsa), dan sinkronisasi keras;\r\n\r\n2 osilator wavetable digital dengan gelombang Prophet VS dan kemampuan pengurutan gelombang, FM dan modulasi cincin.\r\n\r\nPembangkit kebisingan putih.\r\nLFO – 4 LFO masing-masing dengan gigi gergaji, segitiga, ramp, pulsa, dan gelombang acak. Setiap LFO dapat dirutekan ke tujuan manapun dalam matriks. Dapat disinkronkan ke jam MIDI.\r\n\r\nFilter – 2 Filter lolos rendah: 1 filter Curtis analog per saluran, pengoperasian 2 dan 4 kutub yang dapat dipilih (berresonansi sendiri dalam mode 4 kutub) dan generator amplop ADSR.\r\n\r\n2 filter Highpass 4 kutub digital.\r\nVCA – 1 VCA analog per saluran dengan generator amplop ADSR\r\n\r\nArpeg/Seq – Sequencer: 16 x 4 step sequencer bergaya analog yang disinkronkan ke jam MIDI.\r\n\r\nArpeggiator: mode atas, bawah, atas/bawah, dan dapat dialihkan, dan operasi latched.\r\nKeyboard – 3-oktaf, keyboard aksi semi-berbobot dengan kecepatan dan aftertouch.\r\n\r\nEfek – Penundaan digital: 3 jalur penundaan stereo yang terpisah, dapat disinkronkan.\r\n\r\nPutaran umpan balik ganda (saluran kiri dan kanan) yang dapat disetel dengan \"Grunge\": gunakan umpan balik sebagai sumber suara bernada.\r\n\r\nDistorsi! Digital, satu untuk setiap saluran, dapat ditempatkan sebelum atau sesudah elektronik analog; dan “Peretasan Keluaran.”\r\n\r\nPisahkan Glide per osilator.\r\nMemori – 512 program yang dapat diedit sepenuhnya (empat bank 128).\r\nKontrol – MIDI Masuk, Keluar, dan Melalui, dan Rantai Poli.\r\nInput Pedal/CV1 dan Pedal/CV2: merespons pedal ekspresi atau voltase kontrol mulai dari 0 hingga 5 VDC.', 0, NULL),
('Eastman AC122-2CE Accoustic Electric Guitar', 8, 5, 9663697, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Eastman_AC122-2CE_01.jpg?v=1621114277', 'Lebih banyak listrik akustik grand auditorium dari Eastman. AC122-2CE memiliki bagian atas kayu cedar yang kokoh dengan bagian belakang dan samping sapele yang kokoh. Perangkat elektronik Fishman dan kotak gig bag membuat instrumen ini menjadi barang murah.', 0, NULL),
('Eastman AC322CE Accoustic Electric Guitar', 8, 5, 15356597, 'https://cdn.shopify.com/s/files/1/0494/8113/products/AC322CE_Flattop__01.jpg?v=1636568396', 'Semua konstruksi kayu solid dan elektronik LR Baggs yang sangat baik menjadikan Eastman AC322CE dan nilai yang luar biasa. Jika Anda belum pernah memainkan Eastman, Anda benar-benar harus melakukannya.', 0, NULL),
('Eastman AC422CE Accoustic Electric Guitar', 8, 5, 19341627, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Eastman_AC422ce_01.jpg?v=1617985257', 'Akustik/listrik Grand Auditorium yang luar biasa dari Eastman dengan nada rosewood yang indah, elektronik LR Baggs, dan cangkang keras. Instrumen yang terlihat bagus juga!', 0, NULL),
('Eastman DM-1 Gypsy Jazz Accoustic Guitar', 8, 5, 17064467, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Screenshot_2021-01-09DM1.png?v=1610206564', 'Dirancang dengan Doug Martin, gitar Jazz Gypsy ini sebagian besar didasarkan pada model bouche mungil Selmer, yang terkenal dimainkan oleh Django Reinhardt. Bawa diri Anda ke klub jazz Mid-Century Paris dengan instrumen yang benar-benar fantastis ini.', 0, NULL),
('Eastman DT300M Double Top Orchestra Model Accoustic Guitar', 8, 5, 32719942, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Eastman_DT30OM_01.jpg?v=1617486568', 'Gitar Atasan Ganda! Gitar ini menggabungkan bagian atas yang dibuat dengan dua lapisan SOLID Sitka Spruce, di antaranya adalah inti Nomex Honeycomb. Hasilnya adalah pengurangan 30% dalam berat, sambil mempertahankan nada yang kaya dan bersemangat! Bagian belakang dan samping Rosewood India Timur solid, leher Mahoni solid. Termasuk kasus cangkang keras.', 0, NULL),
('Elixir 11027 Nanoweb 80/20 Bronze Acoustic Guitar Strings 11-52', 9, 1, 210000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/E20-11027_1521443931122_735x735.jpg?v=1557468923', 'Senar Perunggu Akustik 80/20 Elixir dengan Lapisan NANOWEB menghasilkan nada yang cerah dan hidup dan lapisan NANOWEB melindungi seluruh senar dan mencegah kotoran keluar dari celah di antara belitan. Ini juga memberikan rasa halus dan mengurangi derit jari untuk meningkatkan permainan dan kinerja. ', 0, NULL),
('Elixir 12002 Nanoweb Electric Guitar Strings 9-42', 9, 1, 160000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/E20-12002_1521443460617_735x735.jpg?v=1557468820', 'Senar Elixir mempertahankan nadanya lebih lama dari senar lainnya, tidak dilapisi atau dilapisi, menurut pemain. Mereka memberikan pemutaran dan nada tahan lama yang bergantung pada artis top di seluruh dunia, dan tersedia dengan lapisan Nanoweb atau Polyweb.\r\n\r\nSenar Baja Berlapis Nikel Listrik Elixir dengan lapisan Nanoweb menghadirkan kehadiran, pukulan, dan detail senar gitar listrik tradisional tetapi dengan umur nada yang diperpanjang.', 0, NULL),
('Ernie Ball Earthwood Light Phosphor Bronze Acoustic Guitar Strings 11-52', 10, 1, 83000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/E10-P02148_1541041719882_735x735.jpg?v=1569667912', 'Senar bass akustik Ernie Ball Earthwood Phosphor Bronze Acoustic Guitar Strings dibuat dari kabel berbahan 92% tembaga, 7.7% timah, 0.3% fosfor yang digulung di kabel inti baja lapis timah berbentuk heksagonal. Senar bass akustik ini memiliki warna emas, oranye cerah, dan menghadirkan suara berdering yang mellow, dengan kejernihan yang sangat baik. ', 0, NULL),
('Ernie Ball Flextune Portable Clip-on Tuner', 10, 1, 300000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FE10-P04112_2FE10-P04112_1619429001060_735x735.jpg?v=1621170793', 'Ernie Ball FlexTune adalah tuner clip-on portabel yang cocok untuk gitar, bass, dan instrumen senar lainnya. Menampilkan layar LCD 2\" berukuran besar, FlexTune memberikan tampilan besar dan hidup yang mudah dibaca dari sudut mana pun. Ini dilengkapi dengan lengan pivot 360 derajat sumbu ganda tuner untuk fleksibilitas penuh untuk memposisikan tampilan sesuai keinginan Anda. FlexTune juga dilengkapi mode tuning Chromatic, Guitar, Bass, Ukulele, dan Biola serta klip dan sensor mikrofon yang dapat dipilih.', 0, NULL),
('Ernie Ball Forest Green Polypro Guitar Strap', 10, 1, 82000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/E10-P04050_1541146773567_735x735.jpg?v=1569667912', 'Strap gitar Ernie Ball Polypro dibuat dari material Polypropylene selebar 2\" yang kokoh dan terasa nyaman. Material tersebut tidak akan melonggar dan warnanya tidak akan pudar. Dijahit dengan mesin dan dilengkapi ujung berbahan kulit yang berkualitas (dengan logo EB yang distempel berwarna emas) untuk menghadirkan ketangguhan terbaik dan agar tahan lama. Panjang bisa disesuaikan dari 41\" hingga 72\".', 0, NULL),
('Fender American Professional Precision Bass Guitar', 11, 2, 26300000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FF03-019-3612-776_2FF03-019-3612-776_1573183044250.jpg?v=1573183052', 'Jika membicarakan instrumen yang bertahan lama, bersuara indah dan berkualitas, anda bisa mengandalkan Fender.\r\n\r\nFender American Professional Precision Bass Guitar yang ikonik membantu setiap gitaris dengan kualitas suara dan permainan terbaik.\r\n\r\nTerasa nyaman ketika dimainkan, Precision Bass memiliki teknologi kontemporer dan baru, menjadikannya gitar yang masih sangat bisa diandalkan.\r\nSpesifikasi\r\nBody Shape	Precision Bass\r\nBody Material	Alder\r\nBody Color	Antique Olive\r\nBody Finish	Gloss Polyurethane\r\nFretboard Material	Maple\r\nFretboard Radius	9.5” (24.1cm)\r\nScale Length	34”\r\nNo. of Frets	20\r\nPickup	Split single-coil configuration, V-Mod Split Single Coil (Mid)\r\nBridge	4-Saddle HiMass™ Vintage (String-Through-Body or Topload)\r\nPickguard	3-Ply Mint Green\r\nStrings	Fender® USA Bass 7250M, NPS (.045-.105 Gauges)\r\nTuning Machines	Fender® Lightweight Vintage-Style Keys with Tapered Shafts\r\nHardware Finish	Chrome', 0, NULL),
('Fender CC60S Accoustic Guitar', 11, 5, 3415597, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Fender_CC60s_Pack_01.png?v=1618693690', 'Pilihan yang bagus untuk penyanyi-penulis lagu pemula, CC-60S yang serba baru bersinar saat dipetik atau dipetik. Ini membanggakan fitur-fitur yang ditingkatkan yang pasti disukai oleh semua jenis pemain, termasuk bagian atas mahoni yang kokoh, fingerboard kenari yang nyaman dengan tepi yang digulung dan bentuk leher baru yang mudah dimainkan.', 0, NULL),
('Fender CD60 Dreadnought Accoustic Guitar', 11, 5, 2846307, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Fender_CD60_Nat_01.png?v=1625589237', 'Jika Anda seorang pemain gitar pemula, pilihan terbaik yang dapat Anda buat adalah mendapatkan gitar dengan suara dan nuansa yang akan menginspirasi Anda untuk terus bermain. CD-60 adalah Fender asli yang terjangkau dan hadir dalam tiga hasil akhir yang tampak hebat agar sesuai dengan gaya Anda. Ini memberikan nada seimbang yang baik dan banyak volume berkat gaya tubuh kapal penempur dan atasan cemara dengan penyangga \"X\" bergigi. CD-60 juga merupakan pilihan yang sangat baik untuk pemain veteran yang membutuhkan model kapal penempur kedua yang murah, dan ini termasuk casing hard-shell untuk transportasi yang aman dan nyaman.', 0, NULL),
('Fender Player Jazz Bass Fretless Bass Guitar', 11, 2, 13200000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/F03-014-9933-515_1545619811889.jpg?v=1557222725', 'Dengan pickup single-coil gandanya dan kesan permainan yang smooth, Player Jazz Bass Left-Handed adalah instrumen yang memiliki gaya dan nada bass Fender yang klasik. Suara kerasnya yang punchy dan rapi; suara menggelegar yang dilengkapi dengan kesan permainan yang halus untuk memunculkan inspirasi kreatif. Bersiaplah beraksi di studio, atau di atas panggung, Player Jazz Bass Left-Handed dapat melakukan apa pun yang anda harapkan—dan segalanya yang belum terpikirkan.\r\n\r\n    Body Shape: Jazz Bass®\r\n    Body Material: Alder\r\n    Body Color: Polar White\r\n    Body Finish: Gloss Polyester\r\n    Fretboard Material: Pau Ferro\r\n    Fretboard Radius: 9.5\" (241 mm)\r\n    Scale Length: 34\" (864 mm)\r\n    Fretboard Inlays: Inlaid Fret Line Markers\r\n    Pickup: Player Series Alnico 5 Single-Coil Jazz Bass® (Middle & Bridge)\r\n    Bridge: 4-Saddle Standard\r\n    Pickguard: 3-Ply Parchment\r\n    Strings: Fender® USA, NPS, (Gauges .045 - .105)\r\n    Tuning Machines: Standard Open-Gear\r\n    Hardware Finish: Nickel/Chrome\r\n', 0, NULL),
...
('GENELEC S360AW SAM TWO WAY STUDIO MONITOR PAIR -WHITE', 13, 10, 148700000, 'https://hariharimusik.id/wp-content/uploads/2020/12/S360AW-1-600x600.jpg', '9.8″ Woofer Frekuensi Rendah\r\n1″ Tweeter Frekuensi Tinggi\r\nPenguat Bass Kelas-D 250W\r\nPenguat Treble Kelas-D 100W\r\nKontrol Komprehensif melalui Perangkat Lunak GLM\r\nKalibrasi Otomatis SAM\r\nKompensasi Respon Kamar\r\nPort Terintegrasi Laminar untuk Bass yang Tepat\r\nInput XLR Analog dan Digital AES/EBU\r\nMonitor Decouple Iso-Plate dari Basis', 0, NULL),
('Gretsch Catalina Club Drums', 14, 4, 10674045, 'https://cdn.shopify.com/s/files/1/0494/8113/products/CT1-J404-GCB.png?v=1605558729', 'Gretsch Catalina Club Series memadukan konfigurasi tradisional dan nada klasik dengan inovasi perangkat keras kontemporer yang ramping. Konfigurasi 4 bagian Catalina Club dibangun di sekitar fondasi bass drum sedalam 14 inci tercinta yang memberikan masing-masing pengaturan ini nada vintage yang hangat dan punchy.\r\n\r\nKomponen perangkat keras Catalina Club memberi seri ini bakat \"Gretsch baru\" khas yang memberi penghormatan pada tradisi perusahaan yang kaya, sambil menanamkan kepribadian yang menarik dan progresif. Dari pelat pemasangan drum bass \"tutup gas\" bundar dan sistem pemasangan Mini GTS hingga braket pemasangan tom bermassa rendah dan sekrup dan baut Gretsch T-Wing, Catalina Club memiliki nuansa ramah drum yang luar biasa.\r\n\r\nCangkang mahoni klasik masih dibangun dengan interior cangkang alami yang sama dan bantalan tepi 30 derajat yang membuatnya terkenal. Drum bass termasuk taji teleskopik dan ring bass drum kayu yang serasi. Drum tom dan snare memiliki fitur 1.6mm triple flanged hoops dan semua drum Catalina Club dilengkapi dengan kepala drum Remo®.', 0, NULL),
...
('IK Multimedia iLoud Micro Monitor White', 16, 10, 7717500, 'https://hariharimusik.id/wp-content/uploads/2021/08/13149961_800.jpg', 'Respon frekuensi linier. Pewarnaan nol. Transparansi. Ruang utama. Untuk mendengar kebenaran, Anda memerlukan referensi pembicara yang menawarkan. Dan jika Anda bekerja di rumah atau studio kecil, Anda memiliki tantangan yang lebih besar, mulai dari kurangnya ruang di meja Anda hingga posisi \"kurang ideal\" dari stasiun kerja audio Anda, biasanya diletakkan di dinding.\r\n\r\nSekarang, dengan iLoud Micro Monitor, Anda dapat mendengar kebenaran dalam musik Anda kapan saja dan di mana saja. Sistem pemantauan referensi studio aktif terkecil di dunia, iLoud Micro Monitor memberi Anda respons frekuensi linier yang sangat akurat tanpa pewarnaan, dan melakukannya di setiap lingkungan mendengarkan, terutama di studio rumah dan proyek.', 0, NULL),
...
('Kinglos 4/4 Blue White Porcelain Colored Violin Solid Wood & Ebony Fittings w/ Shoulder Rest Case Bow Rosin Full Size', 19, 13, 2450000, 'https://ae01.alicdn.com/kf/H807d92063c034795918146d9bb8aee5eF/Kinglos-4-4-Blue-White-Porcelain-Colored-Violin-Solid-Wood-Ebony-Fittings-with-Shoulder-Rest-Case.jpg_Q90.jpg_.webp', 'Bahan: Atasan Cemara Padat, Maple Padat\r\nBelakang & Samping, Fitting Ebony\r\nPakaian Termasuk: kasus, busur\r\nUkuran: 4/4', 0, NULL),
('Kinglos Electric Violin SDDS 1802', 19, 13, 3250000, 'https://images.tokopedia.net/img/cache/900/product-1/2020/8/26/1128348734/1128348734_ee64d67e-b71a-43f0-9d9e-495145ba4276_1279_1279.jpg', 'Model SDDS 1804\r\nBahan: Tubuh Cemara Padat + Bingkai ABS. Perlengkapan Eboni. Sistem Pickup : DV-10B penjemputan aktif, dengan volumr tunrt, 3-band EQ,, mic dan telepon, on-off\r\nSet-up: berdasarkan standar biola tingkat lanjut\r\nPakaian termasuk: kasing, busur, rosin, kabel 4m, earphone, baterai 9V, sandaran bahu khusus', 0, NULL),
('Kinglos PJA1003', 19, 13, 1600000, 'https://ae01.alicdn.com/kf/HTB1V2JjPFXXXXbDXFXXq6xXFXXXP/Kinglos-PJA1003-Full-Size-4-4-3-4-1-2-Solid-Wood-Student-Violin-Fiddle-for.jpg_Q90.jpg_.webp', 'Bahan muka: cemara\r\nBahan belakang/Samping: Maple\r\nBahan atas: Maple\r\nBahan papan jari: kayu eboni\r\nBahan busur: Kayu Brasil\r\nDesain: ukiran bunga\r\nSpesifikasi: 1/2,3/4,4/4\r\n\r\nBerat barang 1.21 pon\r\nDimensi produk 23.23x8.27x3.35 inci', 0, NULL),
('koda essential Clip On Tuner ONE', 20, 1, 115000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FKDA-07133_2FKDA-07133_1632296632291_735x735.jpg?v=1634297151', 'Sangat portabel dan akurat, Clip On Tuner ONE penting koda adalah solusi Anda untuk penyetelan cepat dan mudah saat bepergian. Ukuran dan kompatibilitas penyetelannya membuatnya harus ada di perangkat musik mana pun.', 0, NULL),
('koda essential Electric Guitar Stand ONE', 20, 1, 170000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FKDA-05403_2FKDA-05403_1607931664100_735x735.jpg?v=1610529026', 'Electric Guitar Stand ONE menawarkan cara yang sederhana tapi untuk menyimpan dan menampilkan gitar elektrik efektif anda. Stand yang tinggi ini dapat disesuaikan dan dapat dirakit dengan mudah.', 0, NULL),
('koda essential KIC15 Straight-Straight Instrument Cable 15ft Black', 20, 1, 140000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FKDA-01102_2FKDA-01102_1605687612690_735x735.jpg?v=1605865226', 'KIC15 Instrument Cable didesain untuk menyalurkan nada natural dari sebuah instrumen dengan sesedikit mungkin gangguan. Kabel ini dilapisi untuk memberikan pengoperasian low noise dan dibuat dari material yang kokoh.', 0, NULL),
('koda essential KMC20 Microphone Cable 20ft Black', 20, 1, 185000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FKDA-01107_2FKDA-01107_1605687422040_735x735.jpg?v=1605865289', 'KMC20 Microphone Cable didesain untuk reliabilitas dan memberikan transfer sinyal yang optimal. Kabel ini dilapisi untuk memberikan pengoperasian low noise dan dibuat dari material yang kokoh.', 0, NULL),
('koda essential Music Stand ONE', 20, 1, 230000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/products_2FKDA-05402_2FKDA-05402_1607929966330_735x735.jpg?v=1621394724', 'Music Stand ONE adalah aksesoris yang kokoh dan ringan untuk lembaran musik dan materi instruksi lainnya. Dengan lengan-lengan yang bisa dilipat untuk menopang beberapa halaman dan basis tripod lipat untuk menambah stabilitas. ', 0, NULL),
...
('Ludwig Classic Maple Drums', 22, 4, 31296717, 'https://cdn.shopify.com/s/files/1/0494/8113/products/classicmaple1.png?v=1605560740', 'Jajaran drum Classic Maple Ludwig telah menjadi pilihan di antara musisi profesional selama lebih dari 20 tahun. Drum menampilkan nada penuh, sustain yang kaya, keserbagunaan yang luar biasa, dan tentu saja suara dan performa khas Ludwig. Setiap kit Classic Maple adalah kerajinan tangan di AS yang menggunakan proses yang disempurnakan melalui pembuatan drum selama lebih dari satu abad.\r\n\r\nUkuran drum adalah sebagai berikut:\r\n\r\n14 x 20\" Bass Drum (dengan dudukan drum bass, lug Mini Klasik, kait cakar Klasik, taji Elite)\r\n14 x 14\" Floor Tom (dengan braket kaki Triad dengan kaki floor tom, lug Mini Classic)\r\n8 x 12\" Tom (dengan Atlas tom mount, Mini Classic lugs dengan satu pemegang tom PM0048)', 0, NULL),
...
('Mackie Onyx 24 24-channel Analog Mixer with Multi-track USB', 23, 8, 18350000, 'https://hariharimusik.id/wp-content/uploads/2021/08/onyx24_model-1-600x480.jpg', '18 preamp mikrofon Onyx pemenang penghargaan\r\nSirkuit analog menghasilkan suara berkualitas premium dengan noise minimum\r\nStrip saluran analog/USB dengan perutean fleksibel\r\nEfek tingkat studio dengan opsi penyesuaian pengguna\r\n3-band Perkins EQ dengan sakelar bypass keras On/Off\r\nInput hi-Z yang dapat diganti untuk gitar, bass, dan instrumen lainnya\r\nFilter low-cut 100Hz dan phantom power 48V di semua saluran mikrofon\r\nPerekaman multi-track 24-bit/96kHz resolusi tinggi ke Mac/PC melalui USB\r\nTampilan penuh warna dan antarmuka tombol tunggal\r\nTombol khusus untuk Sebelumnya, Berikutnya, Rekam, dan Putar/Jeda\r\nKemampuan streaming Bluetooth', 0, NULL),
...
('Moog Minimoog Voyager Old School', 26, 11, 54381800, 'https://www.melodiamusik.com/wp-content/uploads/2016/08/Moog-Minimoog-Voyager-Old-School.jpg', 'MINIMOOG® VOYAGER® Old School Synthesizer adalah synthesizer kinerja analog monofonik. Ini memiliki fasilitas patch yang luas, dan kemampuan modulasi yang diperluas. Jalur sinyal dimulai dengan kumpulan tiga osilator yang dikendalikan tegangan dengan jangkauan lebar dan stabilitas tinggi, satu sumber kebisingan dan satu preamplifier audio untuk sinyal audio yang diterapkan secara eksternal. Pengubah suara adalah dua filter Moog dan satu VCA stereo (Voltage Controlled Amplifier).', 0, NULL),
('NEUMANN KH 80 DSP Monitor Speaker /pair', 27, 10, 23625000, 'https://hariharimusik.id/wp-content/uploads/2021/01/KH-80-DSP-Monitor-Speaker-1.jpg', 'Monitor bi-amplified aktif dua arah KH 80 DSP dilengkapi mesin DSP dengan kontrol jaringan, Pemandu Gelombang Dispersi Model Matematika (MMD), input analog, dan beragam perangkat keras pemasangan. Hal ini memungkinkan loudspeaker untuk digunakan dalam kondisi akustik yang beragam, dengan peralatan sumber apa pun dan di berbagai lokasi fisik. KH 80 mewakili teknologi simulasi dan pengukuran akustik dan elektronik terbaru untuk memastikan reproduksi suara seakurat mungkin.', 0, NULL),
('Roland Electric Drum TD-17KVX + Rack MDS-COMPACT', 28, 4, 18380000, 'https://images.tokopedia.net/img/cache/900/VqbcmM/2020/9/22/9fff2e5f-ba79-437a-8a2f-1e2bdef09645.jpg', 'Drum Elektrik Roland TD-17KVX + Rack System MDS-COMPACT.\r\nSuperNatural V-Drums 100% baru.\r\n\r\n* Tidak termasuk kick pedal dan hihat stand\r\n* Roland TD17KVX yang dipasarkan di indonesia tidak terdapat fitur bluetooth.\r\n\r\nBONUS:\r\n- Stick Drum\r\n- 3 DVD berisi\r\n-> E-Drum Games untuk PC/Laptop (include 400 song)\r\n-> 1900 MP3 Minus One Drum', 0, NULL),
...
('Roland VAD306 V-Drums Acoustic Design Electronic Drum Set', 28, 4, 37003707, 'https://cdn.shopify.com/s/files/1/0494/8113/products/vad3061.png?v=1614798109', 'VAD306 adalah kit Desain Akustik V-Drums yang unik, yang sengaja dipadatkan dengan tetap mempertahankan estetika akustik yang khas dari seri ini. Jejaknya sama dengan set V-Drums tingkat menengah, sehingga ideal untuk penggunaan di rumah dan panggung yang sempit. Cangkang dangkal yang dipotong menghemat ruang dan berat—tetapi dari posisi bermain, cangkang ini langsung terasa akrab bagi drummer mana pun. Dudukan penyangga ganda dengan dudukan tom dan lengan boom simbal melengkapi tata letak dan semakin menyempurnakan tema akustik. Dan dengan suaranya yang organik dan ekspresif, modul TD-17 menyediakan semua nada akustik dan kemampuan bermain yang Anda inginkan, baik bermain drum untuk diri sendiri di rumah atau saat manggung di sirkuit bar lokal.', 0, NULL),
('Squier Classic Vibe 60s Jazz Bass Guitar', 29, 2, 7450000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/F03-037-4530-504_1562752550631.jpg?v=1562810185', 'Sebuah penghormatan pada hari kelahirannya, Classic Vibe ‘60s Jazz Bass® memadukan playability mewah yang mentenarkannya dengan fleksibilitas dan nada kerasnya berkat pickup alnico dual single-coil Fender-Designed. Fitur-fitur yang memanjakan pemain adalah profil neck berbentuk “C” yang terasa nyaman dan fingerboard beradius 9.5” dan fret ramping dan juga bridge bergaya vintage dengan threaded saddle. Model Squier ini juga menyertakan marking headstock yang terinspirasi tahun 1960an, hardware lapis nikel yang terlihat mewah dan slick vintage-tint gloss neck finish untuk menampilkan nuansa old-school.', 0, NULL),
...
('TAMA HRM5B Rhythm Mate Hickory Drum Sticks', 30, 1, 100000, 'https://cdn.shopify.com/s/files/1/0117/8740/3323/products/T03-HRM5B_1520849057039.jpg?v=1623681633', 'Seri stik drum Rhythm Mate tersedia dalam berbagai ukuran baik Hickory atau Maple, dan ada sepasang yang sesuai dengan gaya permainan drum apa pun. Seri ini menggunakan sistem ukuran unik TAMA, di mana diameter pegangan, bentuk ujung, dan bahan dapat ditentukan menggunakan nomor produk.', 0, NULL),
('Tanglewood Crossroads Parlor Body', 31, 5, 3557920, 'https://cdn.shopify.com/s/files/1/0494/8113/products/TWCR-P_01.jpg?v=1628285208', 'Gitar Parlor 12 fret kecil yang bagus dari akustik dan akustik/elektrik entry level terbaru kami. Instrumen suara yang sangat baik untuk memulai. Hasil akhir yang bagus juga. Periksa mereka!', 0, NULL),
('TASCAM MODEL 16 MIXER / INTERFACE / RECORDER', 32, 8, 15625000, 'https://hariharimusik.id/wp-content/uploads/2021/01/MODEL-16-1.jpg', 'Translation results\r\nAntarmuka audio terintegrasi untuk 16 saluran (14 input + jumlah stereo)\r\nPerekaman 16-track dimungkinkan dalam format WAV/BWF pada kartu SD/SDHC/SDXC hingga 128 GB\r\n44.1-48 kHz\r\n16/24 Bit\r\nKompresor 1-tombol untuk saluran 1-8\r\nPotongan rendah yang dapat diganti\r\n3-Band EQ dengan mid yang dapat disetel untuk semua saluran mono\r\nEQ 4-Band dengan mid yang dapat disetel untuk jumlah dan subgrup\r\nOverdubbing\r\nPukulan masuk/keluar\r\nLC-Tampilan\r\nPengukur LED 12-segmen\r\nProsesor efek terintegrasi\r\nDaya hantu yang dapat dialihkan: +48 V\r\nAC 100 – 240 V\r\nBluetooth (V5)\r\nKit pemasangan rak tersedia secara terpisah\r\nDimensi (L x T x T): 430 x 113 x 463 mm \r\nMore about this source text\r\nSource text required for additional translation information\r\nSend feedback\r\nSide panels\r\nAntarmuka audio terintegrasi untuk 16 saluran (14 input + jumlah stereo)\r\nPerekaman 16-track dimungkinkan dalam format WAV/BWF pada kartu SD/SDHC/SDXC hingga 128 GB\r\n44.1-48 kHz\r\n16/24 Bit\r\nKompresor 1-tombol untuk saluran 1-8\r\nPotongan rendah yang dapat diganti\r\n3-Band EQ dengan mid yang dapat disetel untuk semua saluran mono\r\nEQ 4-Band dengan mid yang dapat disetel untuk jumlah dan subgrup\r\nOverdubbing\r\nPukulan masuk/keluar\r\nLC-Tampilan\r\nPengukur LED 12-segmen\r\nProsesor efek terintegrasi\r\nDaya hantu yang dapat dialihkan: +48 V\r\nAC 100 – 240 V\r\nBluetooth (V5)\r\nKit pemasangan rak tersedia secara terpisah\r\nDimensi (L x T x T): 430 x 113 x 463 mm', 0, NULL),
...
('VOX Telstar Drum Set', 34, 4, 30000000, 'https://images.tokopedia.net/img/cache/900/VqbcmM/2021/8/31/a5a95e39-110c-4ba1-a066-b94aa41b772d.png', '- Bass Drum : Ukuran Asli (18″+12″ x 13″), 10/20 Lug, Kepala dilapisi putih khusus dibuat oleh REMO\r\nUSA (Atas/Bawah), Tom atau simbal dapat dipasang\r\n- Tom : 13: x 7,5″, Lug 6/12, Kepala dilapisi putih (Atas/Bawah)\r\n- Snare : 14″ x 5″, 8 Lug, Kepala berlapis putih (Atas), Kepala bening (Bawah)\r\n- Lantai Tom : 16″ x 15,5″, Lug 8/16, Kepala dilapisi putih (Atas/Bawah)\r\n- Hi-Hat Stand: Stand flat-base antik dan pedal asli\r\n- Dudukan Snare: Dudukan alas datar antik\r\n- Kick Pedal : Dudukan alas datar antik', 0, NULL),
...
('Yamaha CGS104AII Student Accoustic Guitar', 35, 5, 2134695, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Yamaha_CGS104aII_01.jpg?v=1618681450', 'CGS104AII adalah model ukuran penuh dari Seri SEKOLAH. Ini fitur atas spruce, meranti belakang dan samping, leher nato dan jembatan rosewood dan fingerboard.', 0, NULL),
...
('Yamaha FG800 Solid Top Dreadnought Accoustic Guitar', 35, 5, 3130952, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Yamaha_FG800_01.jpg?v=1571573328', 'Yamaha FG800 akan membawa Anda ke gitar akustik yang solid dengan harga $200. Itu luar biasa. Leher yang dapat dimainkan sangat bagus untuk memulai dengan gitar ini. Yamaha selalu membuat instrumen siswa yang hebat. Seri FG telah ada sejak tahun 1966. Itulah beberapa sejarah musik yang sebenarnya.\r\n\r\nModel akustik standar Yamaha, dengan tampilan sederhana dan tradisional serta kualitas luar biasa, dengan harga terjangkau. Gitar solid-top dengan suara otentik yang seimbang tanpa mengorbankan kekuatannya yang kuat, berkat desain scalloped bracing yang baru dikembangkan. Dapat dengan percaya diri direkomendasikan untuk semua gitaris pemula.\r\n\r\nTubuh Tradisional Barat\r\nAtasan Cemara Padat\r\nBelakang & Samping NATO/Okume\r\nBracing Bergigi yang Baru Dikembangkan\r\nPenampilan tradisional dan kualitas luar biasa', 0, NULL),
('Yamaha FS820 Folk Body Accoustic Guitar', 35, 5, 3984887, 'https://cdn.shopify.com/s/files/1/0494/8113/products/yamaha_FS820_full.jpg?v=1608144577', 'Begitu banyak gitar untuk di bawah $300. Sulit untuk salah dengan Yamaha FS Series.\r\n\r\nSelain suara yang lebih hangat dan kuat, berkat bagian belakang dan samping kayu mahoni, body dan fingerboard binding terbuat dari plastik krem untuk tampilan yang lebih baik. Bodinya yang kecil dan tipis sangat cocok untuk pemain level menengah hingga atas, dengan gaya fingerpicking.\r\n\r\nUkuran Tubuh Kecil\r\nAtasan Cemara Padat\r\nBagian belakang dan samping kayu mahoni\r\nPenguat bergigi', 0, NULL),
('Yamaha FSX800C Folk Body Accoustic Electric Guitar', 35, 5, 4838822, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Yamaha_FSX800c_01.jpg?v=1571573295', 'Akustik-listrik Folk bernilai tinggi\r\nGitar akustik-elektrik Yamaha FSX800C berasal dari warisan panjang gitar akustik \"folk guitar\" FG yang menakjubkan dan memberi Anda nilai luar biasa dengan harga entry-level. Kombinasi gitar tonewood premium menjadikannya nilai yang bagus untuk pemain berpengalaman. Kombinasi bodi folk yang lebih kecil, atasan spruce Sitka yang kokoh, dan bagian belakang dan samping nato bertanggung jawab atas suara indah FSX800C. Dan elektronik System-66 Yamaha membawa suara itu ke atas panggung. Biarkan perjalanan bermain gitar Anda dimulai dengan instrumen luar biasa yang akan Anda sukai selama bertahun-tahun yang akan datang - gitar akustik rakyat Yamaha FSX800C.', 0, NULL),
('Yamaha PAC112V Electric Guitar', 35, 5, 4411855, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Yamaha_PAC112V_NaturalSat_01.jpg?v=1613513279', 'Tubuh Alder dengan Lapisan Poliuretan Gloss\r\nLeher Maple Baut dengan Fingerboard Rosewood\r\nPickup Alnico V Memberikan Nada Hangat dan Jelas\r\nKonfigurasi Pickup H/S/S dengan 5-Position Selector\r\nPush-Pull, Coil-Split Switch untuk Opsi Tonal Tambahan\r\nJembatan Vibrato Bergaya Vintage dengan Pelana Blok', 0, NULL),
('Yamaha PAC311H Electric Guitar', 35, 5, 5977402, 'https://cdn.shopify.com/s/files/1/0494/8113/products/Yamaha_PAC311H_blk_01.jpg?v=1613514339', 'Graph Tech TUSQ Nut\r\nTuner Pengunci Grover\r\nPickup Humbucker dan Tipe P-90\r\nTubuh Alder dengan Leher Maple dan Fingerboard Rosewood\r\nPemilih Penjemputan 3-Posisi\r\nPush-Pull, Coil-Split Switch untuk Opsi Tonal Tambahan', 0, NULL),
...
('Yamaha Rydeen Drum Set', 35, 4, 10300000, 'https://images.tokopedia.net/img/cache/900/VqbcmM/2021/7/2/18984bf3-8d56-4678-97de-88892e44370e.jpg', 'RYDEEN baru (paket cangkang 5 bagian) persis seperti yang ingin dimainkan oleh pemain pemula atau menengah mana pun. Drum set ini menggunakan perangkat keras Yamaha yang menampilkan klem tom dan pipa Asli Yamaha serta menampilkan sentuhan akhir yang solid dan berkilau, masing-masing dengan tiga pilihan warna, dengan total enam tampilan yang dinamis dan bergaya.\r\n\r\nInformasi Produk :\r\n\r\nRDP2F5\r\n\r\nSet Drum Akustik Entri Baru \"RYDEEN\"\r\n\r\n2 Variasi ukuran (5 buah shell pack)\r\n\r\n6 Variasi Warna\r\n\r\nKlem tom dan pipa asli Yamaha\r\n\r\nKepala Drum Bass tipe P3', 0, NULL),
...
INSERT INTO `transaction` (`id`, `user_email`, `total`, `alamat`, `status`) VALUES
(3, 'weifuk@gmail.com', 2553435, 'Jl. Permata Gatsu No 14, Denpasar, Bali', 2),
(4, 'user1@gmail.com', 876000, 'asdasdasdas', 1),
(5, 'user1@gmail.com', 876000, 'asdasdasdas', 1),
(6, 'user1@gmail.com', 876000, 'asdasdasdas', 1),
(7, 'user1@gmail.com', 1440000, 'coba alamat', 1),
(8, 'weifuk@gmail.com', 832000, 'Cba alamat 12', 2),
(9, 'user1@gmail.com', 348000000, 'asdasdsadadasdada', 1),
(10, 'user1@gmail.com', 203000000, 'Coba beda warna', 1);
...
INSERT INTO `transaction_items` (`id`, `transaction_id`, `items_name`, `quantity`, `color_id`) VALUES
(1, 3, 'Amahi UK550C Classic Series Flamed Maple Concert Ukulele', 1, 1),
(2, 3, 'Amahi UK550C Classic Series Flamed Maple Concert Ukulele', 1, 2),
(3, 4, 'Behringer SL 85S Dynamic Cardioid Handheld Microphone', 3, 12),
(4, 5, 'Behringer SL 85S Dynamic Cardioid Handheld Microphone', 3, 12),
(5, 6, 'Behringer SL 85S Dynamic Cardioid Handheld Microphone', 3, 12),
(6, 7, 'Behringer SL 84C Dynamic Cardioid Microphone', 3, 12),
(7, 7, 'Behringer XM8500 Ultravoice Dynamic Cardioid Vocal Microphone', 3, 12),
(8, 8, 'Behringer SL 75C Cardioid Dynamic Microphone', 1, 12),
(9, 8, 'Behringer SL 84C Dynamic Cardioid Microphone', 3, 12),
(10, 9, 'D Angelico Deluxe DC Semi-Hollow Electric Guitar w/Stairstep Tailpiece', 12, 8),
(11, 10, 'D Angelico Deluxe DC Semi-Hollow Electric Guitar w/Stairstep Tailpiece', 2, 8),
(12, 10, 'D Angelico Deluxe DC Semi-Hollow Electric Guitar w/Stairstep Tailpiece', 4, 9),
(13, 10, 'D Angelico Deluxe DC Semi-Hollow Electric Guitar w/Stairstep Tailpiece', 1, 7);
...
('lukassbudi@gmail.com', 'lukasbudi', 'Mysuperstar123', 'Test Test', 14, 262, '2021-11-21', 1, 1),
('user1@gmail.com', 'user1', 'user1', 'user1', 19, 296, '2001-01-01', 1, 1),
...
INSERT INTO `wishlist` (`id`, `user_email`, `items_name`) VALUES
(1, 'weifuk@gmail.com', 'Amahi UK550C Classic Series Flamed Maple Concert Ukulele'),
(2, 'weifuk@gmail.com', 'BEHRINGER PMP550M 500-Watt 5-Channel Powered Mixer'),
(3, 'weifuk@gmail.com', 'Elixir 12002 Nanoweb Electric Guitar Strings 9-42'),
(4, 'weifuk@gmail.com', 'Amahi UK770C Classic Series Spalted Maple Concert Ukulele');
